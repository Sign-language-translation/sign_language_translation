...
#     Bidirectional, LSTM, BatchNormalization, Dropout, Dense, Layer
# )
...
# import pickle
#
# # Ensure non-GUI backend for plotting
# import matplotlib
# matplotlib.use('Agg')
#
#
...
#     """
#     Build a 3D-CNN + BiLSTM + Self-Attention model.
#
...
#     plt.savefig("models/local_models/training_history_attention.png")
#     plt.close()
#
#     return history
#
...
#     """
#     Load all examples from your DB, convert JSON → feature matrices.
#     Returns X (N, T, H, W, C) and list of labels.
#     """
#     vecs, labels = [], []
#     for idx, raw_label, cat, json_str in read_all():
#         try:
#             data = json.loads(json_str)
#             mat = create_feature_vector(data)   # (T, H, W, C)
#             vecs.append(mat)
#             labels.append(raw_label.split('_')[0])
...
#     pkl_file_name=None,
#     model_filename=None,
#     models_folder_path="models/local_models"
# ):
#     # 1) load data
...
#
#     # 3) build model
#     input_shape = X_train.shape[1:]   # e.g. (150,75,3)
#     num_classes = len(encoder.classes_)
#     model = build_3dcnn_rnn_with_attention(input_shape, num_classes)
#     model.summary()
#
#     # 4) train
#     train_model(model, X_train, y_train, class_weights)
#
#     # 5) evaluate
...
#     videos_per_word = len(labels) // num_classes
#     pkl_file_name   = pkl_file_name   or f"label_encoder_attn_{videos_per_word}_vpw.pkl"
#     model_filename  = model_filename  or f"3d_rnn_cnn_attn_on_{videos_per_word}_vpw.keras"
#
